...
export const STARTER_RULES: StarterRuleDef[] = [
  ...
  },
  {
    ...
    tags: ['transport'],
    payeeName: null,
    categoryTargets: { personal: 'Parking & tolls', business: 'Parking & tolls' },
    conditions: { any: [
  ...
  },
  {
    ...
    tags: ['transport'],
    payeeName: null,
    categoryTargets: { personal: 'Public transit', business: 'Ground transportation' },
    conditions: { any: [
      { field: 'description', operator: 'contains', value: 'transit' },
      { field: 'description', operator: 'contains', value: 'subway' },
      { field: 'description', operator: 'contains', value: 'metro' },
      { field: 'description', operator: 'contains', value: 'tram' },
      { field: 'description', operator: 'contains', value: 'bus pass' },
      { field: 'description', operator: 'contains', value: 'train ticket' },
    ]},
  },
  ...
  // ── KEYWORD PATTERNS — UTILITIES ──────────────
  {
    ...
    tags: ['utilities'],
    payeeName: null,
    categoryTargets: { personal: 'Electric & gas', business: 'Electric & gas' },
    conditions: { any: [
      ...
      { field: 'description', operator: 'contains', value: 'gas bill' },
    ]},
  },
  {
    id: 'kw-water',
    ...
    tags: ['utilities'],
    payeeName: null,
    categoryTargets: { personal: 'Water & sewer', business: 'Water & sewer' },
    conditions: { any: [
