...
import { stashPendingMarkSentQuote, removePendingMarkSentQuote } from '@/lib/pending-mark-sent'
...
export function QuoteDownloadBanner({ projectId, quoteId, quoteNumber, clientName, onDone }: Props) {
  ...
  async function handleMarkSent() {
    ...
    try {
      ...
      removePendingMarkSentQuote(quoteId)
      onDone()
    } catch {
  ...
  function handleNotYet() {
    stashPendingMarkSentQuote({
      ...
      quoteNumber,
      projectId,
      projectSlug: '', // projectSlug not available here; orchestrator should fill it
