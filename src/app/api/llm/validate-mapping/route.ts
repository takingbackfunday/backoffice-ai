...
export async function POST(request: Request) {
  try {
    ...
    // Extract sample values from the detected amount column for sign inference
    ...
    const prompt = `You are a bank CSV expert. Given column headers and sample rows from a bank CSV, validate the column mapping AND detect the amount sign convention.
